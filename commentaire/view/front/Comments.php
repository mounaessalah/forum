...
$approved_comments = $commentaireC->getApprovedComments();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="../back/image/image.png">
  <link rel="icon" type="image/png" href="../back/image/image.png">
  <title>
   CreaNova
  </title>
  <!--     Fonts and icons     -->
  ...
  <link href="../back/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="../back/assets/css/soft-ui-dashboard.css" rel="stylesheet" />
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <!-- <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank"> -->
        <img src="../back/image/image.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">CreaNova</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../back/listForum.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../back/">
            ...
            <span class="nav-link-text ms-1">ressource</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="../back/">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">forum</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
          <div class="input-group">
    <form method="post" action="recherche.php"> <!-- Replace "search_commentaire.php" with the URL of your PHP script -->
        <label for="auteur_input">Entrer un nom</label>
        <input type="text" id="auteur_input" name="auteur" placeholder="Entrer un nom">
...
<table border="2" align="center" width="70%">
    <tr>
        <th>Auteur</th>
        <th>Contenu</th>
        <th>Likes</th> <!-- New column for displaying likes -->
    </tr>
    <?php foreach ($approved_comments as $commentaire) { ?>
    <tr>
        <td><?= $commentaire['auteur']; ?></td>
        <td><?= $commentaire['contenu']; ?></td>
        <td id="likes_<?php echo $commentaire['id_forum']; ?>">
            <?= $commentaire['likes']; ?> <!-- Display current number of likes -->
        </td>
        <td>
            <!-- Button to increment likes -->
            <button class="like-button" data-comment-id="<?php echo $commentaire['id_forum']; ?>">Like</button>
        </td>
    </tr>
    <?php } ?>
</table>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    likeButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            // Send AJAX request to likeComment.php with comment ID
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    document.getElementById('likes_' + commentId).textContent = xhr.responseText;
                }
            };
