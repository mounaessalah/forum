...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <form method="post" action="search.php"> <!-- Replace "search_commentaire.php" with the URL of your PHP script -->
        <label for="id_forum_input">Enter id_forum:</label>
        <input type="text" id="id_forum_input" name="id_forum" placeholder="Enter id_forum">
...
<table border="2" align="center" width="70%">
    ...
    <tr>
        ...
        <td align="center">
            <!-- Add form for approval -->
            <form method="POST" action="approveCommentaire.php">
                <input type="hidden" name="comment_id" value="<?= $commentaire['id_forum']; ?>">
                <button type="submit" name="approve_comment">Approve</button>
            </form>
            <!-- Add form for denial -->
            <form method="POST" action="denyCommentaire.php">
                <input type="hidden" name="comment_id" value="<?= $commentaire['id_forum']; ?>">
                <button type="submit" name="deny_comment">Deny</button>
            </form>
        </td>
        <td>
            <a href="deleteCommentaire.php?id_forum=<?= $commentaire['id_forum']; ?>" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a>
        </td>
